...
**Clicking** a launch-site dot selects all of that site's jobs at once — handy for then routing, exporting, or moving the whole parking-spot group together via the map-view toolbar.
