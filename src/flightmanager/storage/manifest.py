...
from flightmanager.geo.geometry import SurveyGeometry
...
_CC_BY = {
    ...
    "zones": ("Contains data from Traficom, UAS Geographical Zones, retrieved {date}."),
}
    ...
    return {
        ...
        **(
        ...
        "flight": {
            ...
            "strip_speed_ms": round(strip_speed_ms, 2)
            if strip_speed_ms is not None
            else None,
        ...
        "battery": (
            (
                {
                    ...
                    "estimated_flight_time_min": round(
                        kmz_results[0].estimated_flight_time_min, 1
                    ),
            ...
            if kmz_results
            else {"note": "dry_run — not computed"}
        ),
        "dsm": (
            {
        ...
        "home_safety": {
            ...
            "min_dist_to_home_m": (
                ...
                if survey_geom.min_dist_to_home_m is not None
                else None
            ),
